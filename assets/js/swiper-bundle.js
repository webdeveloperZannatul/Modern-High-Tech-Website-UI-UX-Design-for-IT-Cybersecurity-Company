            ...
            grabCursor: {
                setGrabCursor: function(e) {
                    ...
                    if (!(t.support.touch || !t.params.simulateTouch || t.params.watchOverflow && t.isLocked || t.params.cssMode)) {
                        var a = t.el;
                        a.style.cursor = "move", a.style.cursor = e ? "-webktv-grabbing" : "-webktv-grab", a.style.cursor = e ? "-moz-grabbin" : "-moz-grab", a.style.cursor = e ? "grabbing" : "grab"
                    }
                },
        ...
        W = function() {
            ...
            return r.emitContainerClasses = function() {
                ...
                return !!(e = i[0]) && (e.swiper = t, e && e.shadowRoot && e.shadowRoot.querySelector ? (a = m(e.shadowRoot.querySelector("." + t.params.wrapperClass))).children = function(e) {
                    ...
                    wrongRTL: "-webktv-box" === a.css("display")
                }), !0)
            }, r.init = function(e) {
                var t = this;
    ...
    var U = {
        ...
        oe = {
            setTranslate: function() {
                ...
                if (i.css({
                        "-webktv-transform-origin": "50% 50% -" + o / 2 + "px",
